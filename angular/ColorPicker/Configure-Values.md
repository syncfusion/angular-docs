...
{% highlight html %}
    ...
    <div align="center">
    <input id="colorPicker" type="text" [(opacityValue)]="opacityValue" ej-colorpicker [(ngModel)]="value" />
    </div>
...
![](/Angular/ColorPicker/Configure-Values_images/Configure-Values_img1.png) 
...
{% highlight html %}
    ...
    <div align="center">
    <input id="picker" ej-colorpicker [(ngModel)]="value" [(tooltipText)]="tooltipText" [(buttonText)]="buttonText" [(modelType)]="type"/>
    </div>    
...
export class PaletteComponent {
  ...
  constructor() {
    this.value = '#ec2024';
    this.type = 'palette';
    this.buttonText = { apply: "aplicar ", cancel: "cancelar" };
    this.tooltipText = { sandy: "arenoso" };
  }
}
...
![](/Angular/ColorPicker/Configure-Values_images/Configure-Values_img2.png) 
