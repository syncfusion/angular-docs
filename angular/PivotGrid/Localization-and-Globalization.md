...
You can localize the PivotGrid controls text with a collection of localized strings using [`ej.PivotGrid.Locale`](/api/angular/ejpivotgrid#members:locale) for different cultures. By default, the PivotGrid control is localized in **"en-US"** culture.
...
<!--Create a tag which acts as a container for PivotGrid-->
 <ej-pivotgrid id="PivotGrid1" locale="fr-FR" pivotTableFieldListID="PivotSchemaDesigner1" >
</ej-pivotgrid>
<!--Create a tag which acts as a container for PivotTable Field List-->
<ej-pivotschemadesigner id="PivotSchemaDesigner1" locale="fr-FR" ></ej-pivotschemadesigner>
<!--Create a tag which acts as a container for PivotPager-->
<ej-pivotpager id="PivotPager1" targetControlID="PivotGrid1" locale="fr-FR" ></ej-pivotpager>
...
<ej-pivotgrid dataSource.data="http://bi.syncfusion.com/olap/msmdpump.dll; Locale Identifier=1036;" locale="fr-FR">
</ej-pivotgrid>
...
//1036 refers to “fr-FR” culture.
<ej-pivotgrid [dataSource]="dataSource" locale="fr-FR">
</ej-pivotgrid>
...
You can render our PivotGrid control from Right to Left by setting [`enableRTL`](/api/angular/ejpivotgrid#members:enablertl) property to true.
