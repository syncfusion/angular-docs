...
{% highlight html %}
    ...
    <ej-scroller id="scroll" height="300" width="600" [(enableTouchScroll)]="touch" style="display:block;border:1px solid #bbbcbb">
    <div>
...
![](/Angular/Scroller/Thumb-Scrolling_images/Thumb-Scrolling_img1.png)
